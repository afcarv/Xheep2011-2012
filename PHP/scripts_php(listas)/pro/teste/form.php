...
<table width="1150" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="360" valign="bottom" class="centertable"><table width="1150" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="274" height="157"><object width="274" height="157">
        ...
        <td align="center" valign="bottom"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="25" colspan="3" align="center" valign="bottom">Formulário de Registo <span class="Boldtitulo">XHEEP.COM</span></td>
          </tr>
          <tr>
            <td width="5%">&nbsp;</td>
            <td width="90%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="260" height="17" align="left" valign="bottom" class="left">Empresa </td>
                <td width="260" align="left" valign="bottom" class="left">Morada / Rua</td>
                <td width="233" align="left" valign="bottom" class="left">E-Mail</td>
              ...
              <tr>
                <td height="17" align="left" valign="bottom" class="left">Nome </td>
                <td align="left" valign="bottom" class="left">Código Postal </td>
                <td align="left" valign="bottom" class="left">Telemóvel (+351)</td>
                <td width="32" valign="bottom" class="left">&nbsp;</td>
              </tr>
              <tr>
              ...
              <tr>
                <td height="17" align="left" valign="bottom" class="left">Apelido </td>
                <td align="left" valign="bottom" class="left">localidade</td>
                <td align="left" valign="middle" class="left">&nbsp;</td>
                <td width="32">&nbsp;</td>
              </tr>
              <tr>
                <td align="left" class="left"><input name="apelido" value="'.$apelido.'" type="text" id="apelido" size="35" /></td>
                <td align="left" class="left"><input name="codpost3" value="'.$codpost3.'" type="text" id="codpost3" size="35" /></td>
                <td align="left" valign="bottom" class="left"><input type="checkbox" value="SIM" name="aceite">
