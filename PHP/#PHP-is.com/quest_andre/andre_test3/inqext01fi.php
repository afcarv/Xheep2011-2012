...
// Definições GLOBAIS
		...
		$idtab = 'impresso_ISsite.inqext01';
...
echo '
					...
					</td><td><IMG SRC="/quest_andre/test3/cabecalho-final.jpg" ALT="IPL"  border=0>
					<br><br>
...
<tr><td>
<br><br>  Simpatia e disponibilidade dos colaboradores</td><td align="center"><?php lfdx("2010",$inq,$vinq,"1",""); ?> </td><td align="center"><?php lfdx("2010",$inq,$vinq,"2",""); ?> </td><td align="center"> <?php lfdx("2010",$inq,$vinq,"3",""); ?> </td><td align="center"><?php lfdx("2010",$inq,$vinq,"4",""); ?></td><td align="center"><?php lfdx("2010",$inq,$vinq,"5",""); ?>
</td></tr>

<tr><td>
<br><br>Qualidade do serviço prestado</td><td align="center"><?php lfdx("2020",$inq,$vinq,"1",""); ?> </td><td align="center"><?php lfdx("2020",$inq,$vinq,"2",""); ?> </td><td align="center"> <?php lfdx("2020",$inq,$vinq,"3",""); ?> </td><td align="center"><?php lfdx("2020",$inq,$vinq,"4",""); ?></td><td align="center"><?php lfdx("2020",$inq,$vinq,"5",""); ?>
</td></tr>

<tr><td>
<br><br>Soluções oferecidas pelos nossos produtos</td><td align="center"><?php lfdx("2030",$inq,$vinq,"1",""); ?> </td><td align="center"><?php lfdx("2030",$inq,$vinq,"2",""); ?> </td><td align="center"> <?php lfdx("2030",$inq,$vinq,"3",""); ?> </td><td align="center"><?php lfdx("2030",$inq,$vinq,"4",""); ?></td><td align="center"><?php lfdx("2030",$inq,$vinq,"5",""); ?>
</td></tr>

<tr><td>
<br><br>Responsabilidade dos nossos Serviços Técnicos</td><td align="center"><?php lfdx("2040",$inq,$vinq,"1",""); ?> </td><td align="center"><?php lfdx("2040",$inq,$vinq,"2",""); ?> </td><td align="center"> <?php lfdx("2040",$inq,$vinq,"3",""); ?> </td><td align="center"><?php lfdx("2040",$inq,$vinq,"4",""); ?></td><td align="center"><?php lfdx("2040",$inq,$vinq,"5",""); ?>
</td></tr>

<tr><td>
<br><br>Tempo de resposta/execução dos nossos serviços Técnicos</td><td align="center"><?php lfdx("2050",$inq,$vinq,"1",""); ?> </td><td align="center"><?php lfdx("2050",$inq,$vinq,"2",""); ?> </td><td align="center"> <?php lfdx("2050",$inq,$vinq,"3",""); ?> </td><td align="center"><?php lfdx("2050",$inq,$vinq,"4",""); ?></td><td align="center"><?php lfdx("2050",$inq,$vinq,"5",""); ?>
</td></tr>

<tr><td>
<br><br>Satisfação geral com os nossos serviços técnicos</td><td align="center"><?php lfdx("2060",$inq,$vinq,"1",""); ?> </td><td align="center"><?php lfdx("2060",$inq,$vinq,"2",""); ?> </td><td align="center"> <?php lfdx("2060",$inq,$vinq,"3",""); ?> </td><td align="center"><?php lfdx("2060",$inq,$vinq,"4",""); ?></td><td align="center"><?php lfdx("2060",$inq,$vinq,"5",""); ?>
</td></tr>

<tr><td>
<br><br>Como classifica os materiais e equipamentos da empresa</td><td align="center"><?php lfdx("2070",$inq,$vinq,"1",""); ?> </td><td align="center"><?php lfdx("2070",$inq,$vinq,"2",""); ?> </td><td align="center"> <?php lfdx("2070",$inq,$vinq,"3",""); ?> </td><td align="center"><?php lfdx("2070",$inq,$vinq,"4",""); ?></td><td align="center"><?php lfdx("2070",$inq,$vinq,"5",""); ?>
</td></tr>
...
<br><big><strong>Sugeria a Impressões e Soluções? &nbsp;&nbsp;&nbsp; </strong></big><br>Sim<?php lfdx("6030",$inq,$vinq,"SIM",""); ?> | Não<?php lfdx("6030",$inq,$vinq,"NAO",""); ?>
...
echo '<table border =0 width ="'. $lq . '">
    <tr><td>
    <p align="right"> página:'.$pag.' /  '. $pagtot . 
	'</p><p align="center">';

if( $pag > 1 ) { // permite andar para a anterior
 printf("<input type=\"button\" value=\" ««« Página anterior\" onclick=\"javascript:PagAnt(this.form)\">&nbsp;");
}
 if( $pag < $pagtot ) { // permite andar para a seguinte
 printf("<input type=\"button\" value=\"Página seguinte »»» \" onclick=\"javascript:PagSeg(this.form)\">&nbsp;");
 }
