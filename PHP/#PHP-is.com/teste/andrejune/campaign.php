...
*/
	...
	echo '<strong> Cor preferida: </strong>';
	...
	printf("<br><tr><td>Azul <input type=\"radio\" name=\"opcao\" value=\"%s\" %s ></td></tr><br>", "Azul" , $xche);
	...
	printf("<tr><td>Verde <input type=\"radio\" name=\"opcao\" value=\"%s\" %s ></td></tr><br>", "Verde" , $xche);
	...
	printf("<tr><td>Vermelho <input type=\"radio\" name=\"opcao\" value=\"%s\" %s ></td></tr><br>", "Vermelho" , $xche);
