...
if($notificationemail == "1"){
		...
		$fromname = "Impressoes e Soluções - Novo Registo de Utilizador";
		$from = "andre@impressoesesolucoes.com";
		$recipient = $email;
		$subject = "Registo no site da Impressões e Soluções, Lda";
		$body   = 'Obrigado '. $nome .
				'.<br>Agradecemos o seu registo no site da Impressoões e soluções. <br /> Os dados da sua conta são:<br><hr> - utlizador:' .
				$usn. '<br>- password: ' . $password .
				'<hr> Guarde este email para futuros acessos à área de cliente do site Impressões e Soluções. <br> <br> Aceda ao site de Impressões e Soluções com a sua nova conta:<br>www.impressoesesolucoes.com<br><br><br><br>Equipa da Impressões e Soluções, Lda';
		//Send notification
...
- utlizador:' .
$usn. '<br>- password: ' . $password .
'<br>Pode confirmar estes dados através do email que lhe enviámos. Guarde-os para futuros acessos ao nosso website. <br><br><br><br>A equipa da Impressões e Soluções, Lda ';
}
...
<table width="705" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#EAEAEA">
  <tr>
    <td width="25" rowspan="11" align="left" valign="middle">&nbsp;</td>
    <td width="280" align="left" valign="top">&nbsp;</td>
    <td width="30" rowspan="11" align="left" valign="top">&nbsp;</td>
    <td width="360" align="left" valign="top">&nbsp;</td>
    <td width="25" rowspan="11" align="left" valign="middle">&nbsp;</td>
  </tr>
  <tr>
    <td width="280" align="left"><strong>Nome:</strong></td>
    <td width="360" align="left"><strong>Apelido:</strong></td>
  </tr>
  <tr>
    <td width="280" align="left"><strong>
      <input type="text" name="nome" value="'.$nome.'" size="40" />
    </strong></td>
    <td width="360" align="left"><input type="text" name="apelido" value="'.$apelido.'" size="40" id="apelido" /></td>
  </tr>
  <tr>
    <td width="280" align="left"><strong><br />
    Email:</strong></td>
    <td width="360" align="left"><strong><br />
    Morada:</strong></td>
  </tr>
  <tr>
    <td width="280" align="left" valign="top"><input type="text" name="email" value="'.$email.'" size="40" /></td>
    <td width="360" align="left"><input name="morada" type="text" value="'.$morada.'" size="45" /></td>
  </tr>
  <tr>
    <td width="280" align="left"><strong>Município:</strong></td>
    <td width="360" align="left"><strong>Código Postal:</strong></td>
  </tr>
  <tr>
    <td width="280" align="left"><select name="municip">
      <option selected="selected">Clique para abrir Lista</option>
 ...
 echo '
    ...
    <td width="360" align="left" valign="top"><input name="codpost1" type="text" value="'.$codpost1.'" size="4" maxlength="4" />
      -
      <input name="codpost2" type="text" value="'.$codpost2.'" size="3" maxlength="3" /> 
      <input type="text" name="codpost3" value="'.$codpost3.'" size="25" /></td>
  </tr>
  <tr>
    <td width="280" align="left" valign="top"><strong><br />
    Telemóvel: (+351)
        <input type="text" name="telemovel" value="'.$telemovel.'" size="9" id="telemovel" />
    </strong></td>
    <td width="360" align="left"><strong><br />
    Sexo:</strong></td>
  </tr>
  <tr>
    <td width="280" align="left" valign="middle">&nbsp;</td>
    <td width="360" align="left" valign="middle">Masculino<strong> 
...
echo ' >
  ...
  <tr>
    <td width="280" align="left"><p><strong>Aniversário:</strong>
 (AAAA-MM-DD)
     <input type="text" name="aniversario" value="'.$aniversario.'" size="10" />
    </p></td>
    <td width="360" align="left" valign="bottom">Li e confirmo que aceito os Termos de Serviço!
    <input type="checkbox" value="SIM" name="aceite" id="aceite" /></td>
  </tr>
  <tr>
    <td width="280" align="left" valign="top"><p><br />
    </p></td>
