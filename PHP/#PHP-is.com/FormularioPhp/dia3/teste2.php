...
<tr><td valign=top><strong>Dia:</strong></strong></td></tr>
<tr> <td>
    <select name="dia">
    <option selected>Selecione</option>';
 ...
 echo '</select>
	...
	<tr><td valign=top><strong>Mês:</strong></strong></td></tr>
<tr> <td>
    <select name="mes">
    <option selected>Selecione</option>';
	if ( strlen($mes) == 0) $mes = "1";
	foreach ($mes as $nm2) {
...
<tr> <td><strong><input type="text" name="aniversario" value="'.$aniversario.'" size="15"> Indique-nos o seu Aniverário, para receber uma prenda.</strong></td></tr>
