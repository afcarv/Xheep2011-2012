...
if($notificationemail == "1"){
		...
		$fromname = "Impress";
		$from = "afcarvalho@anmp.pt";
		$recipient = $email;
		$subject = "Registo no nosso site";
		$body   = '<hr> Obrigado '. $nome .
				' Agradecemos o seu registo, <br /> a sua conta tem é:<br> - utlizador:' .
...
//send notification to admin
	...
	$from = "afcarvalho@anmp.pt";
	$recipient = $from;
	$subject = "A new user has been added joomla";
...
<hr>
Obrigado '. $nome .
' Agradecemos o seu registo, <br /> a sua conta tem é:<br>
- utlizador:' .
$usn. '<br>- password: ' . $password .
'<hr>';
}
