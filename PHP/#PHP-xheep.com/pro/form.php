...
echo '<table width="1150" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="215" align="center" valign="middle" style= "color:#ffffff;font-size:20px;"><b>Obrigado '. $nome .
				'.<br>Agradecemos o seu registo. <br /> <br> <br> Esteja atento às nossas soluções de negócio.</b><br><br><br><br><br>&nbsp;</td>
  </tr>
</table>';
...
<table width="1150" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="274" height="187" valign="bottom">&nbsp;</td>
    <td height="187" valign="top" background="/images/background/bottom_promo_formulario_registo_big.jpg" > <table width="100%" border="0" cellspacing="0" cellpadding="0"  >
      <tr>
        <b><td height="27" colspan="3" align="center" valign="bottom"  style= "color:#ffffff;font-size:14px;" >&nbsp;</td></b>
      </tr>
      <tr>
        <td width="5%" height="128">&nbsp;</td>
        <td width="90%" height="128"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="260" height="22" align="left" valign="bottom" class="tahoma10white" style= "color:#ffffff;font-size:10px;"><span class="tahoma10white">Empresa </span></td>
            <td width="260" height="22" align="left" valign="bottom" class="tahoma10white" style= "color:#ffffff;font-size:10px;"><span class="tahoma10white">Morada / Rua</span></td>
            <td width="233" height="22" align="left" valign="bottom" class="tahoma10white" style= "color:#ffffff;font-size:10px;"><span class="tahoma10white">E-Mail</span></td>
            <td width="4" height="22" rowspan="6" valign="bottom" class="left">&nbsp;</td>
            <td width="32" height="22" valign="bottom" class="left">&nbsp;</td>
          </tr>
          <tr>
            <td align="left" class="left"><input name="empresa" value="'.$empresa.'" type="text" id="empresa" size="35" tabindex="1"/></td>
            <td align="left" class="left"><input name="morada" value="'.$morada.'" type="text" id="morada" size="35" tabindex="4"/></td>
            <td align="left" class="left"><input name="email" value="'.$email.'" type="text" id="email" size="25" tabindex="8"/></td>
            <td width="32" class="left">&nbsp;</td>
          </tr>
          <tr>
            <td height="20" align="left" valign="bottom" class="tahoma10white"><span class="tahoma10white" style= "color:#ffffff;font-size:10px;">Nome </span></td>
            <td height="20" align="left" valign="bottom" class="tahoma10white"><span class="tahoma10white" style= "color:#ffffff;font-size:10px;">Código Postal </span></td>
            <td height="20" align="left" valign="bottom" class="tahoma10white"><span class="tahoma10white" style= "color:#ffffff;font-size:10px;">Telemóvel (+351)</span></td>
            <td width="32" height="20" valign="bottom" class="left">&nbsp;</td>
          </tr>
          <tr>
            <td align="left" class="left"><input name="nome" value="'.$nome.'" type="text" id="nome" size="35" tabindex="2"/></td>
            <td align="left" class="left"><input name="codpost1" value="'.$codpost1.'" type="text" id="codpost1" size="4" maxlength="4" tabindex="5"/>
              -
              <input name="codpost2" value="'.$codpost2.'" type="text" id="codpost2" size="3" maxlength="3" tabindex="6"/></td>
            <td align="left" class="left"><input name="telemovel" value="'.$telemovel.'" type="text" id="telemovel" size="25" maxlength="9" tabindex="9"/></td>
            <td width="32" class="left">&nbsp;</td>
          </tr>
          <tr>
            <td height="20" align="left" valign="bottom" class="tahoma10white"  style= "color:#ffffff;font-size:10px;">Apelido </td>
            <td height="20" align="left" valign="bottom" class="tahoma10white" style= "color:#ffffff;font-size:10px;" >Localidade</td>
            ...
            <td height="20" align="left" valign="middle" class="left">&nbsp;</td>
            <td width="32" height="20">&nbsp;</td>
          </tr>
          <tr>
            <td height="20" align="left" valign="top" class="left"><input name="apelido" value="'.$apelido.'" type="text" id="apelido" size="35" tabindex="3"/></td>
            <td height="20" align="left" valign="top" class="left"><input name="codpost3" value="'.$codpost3.'" type="text" id="codpost3" size="35" tabindex="7"/></td>
            <td height="20" align="left" valign="bottom" class="left"><input type="checkbox" value="SIM" name="aceite" tabindex="10">
              <span class="tahoma10white"  style= "color:#ffffff;font-size:10px;">Aceito as Condições de Registo deste Site.</span></td>
            <td width="32" height="20" valign="top"><input type="submit" name="button" id="button" value="OK" tabindex="11"/></td>
      ...
      <tr>
        ...
        <td height="31" align class="tahoma10white" "left" style="color:#F00" >           '.$mensagemFinal.'&nbsp;</td>
        <td height="31">&nbsp;</td>
      </tr>
    </table></td>
  </tr>
