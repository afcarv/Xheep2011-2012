...
echo '<table width="1150" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="215" align="center" valign="middle" style= "color:#ffffff;font-size:20px;"><b>Obrigado '. $nome .
				'.<br>Agradecemos o seu registo.<br> Esteja atento às nossas soluções de negócio.</b><br><br><br><br><br>&nbsp;</td>
  </tr>
</table>';
...
<table width="1150" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="274" height="215" valign="bottom"><object width="274" height="157">
    ...
    <td height="215" valign="top" background="/images/background/bottom_promo_formulario_registo_big.jpg" > <table width="100%" border="0" cellspacing="0" cellpadding="0"  >
      <tr>
        <b><td height="37" colspan="3" align="center" valign="bottom"  style= "color:#ffffff;font-size:14px;" ><b>Formulário de Registo </b><span class="bold"><b>XHEEP.COM</b></span></td></b>
      </tr>
      <tr>
        <td width="5%">&nbsp;</td>
        <td width="90%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td align="left" class="left"><input name="aniversario" value="'.$aniversario.'" type="text" id="aniversario" size="35" /></td>
            <td align="left" class="left"><input name="morada" value="'.$morada.'" type="text" id="morada" size="35" /></td>
            <td align="left" class="left"><input name="email" value="'.$email.'" type="text" id="email" size="25" /></td>
          ...
          <tr>
            <td align="left" class="left"><input name="nome" value="'.$nome.'" type="text" id="nome" size="35" /></td>
            <td align="left" class="left"><input name="codpost1" value="'.$codpost1.'" type="text" id="codpost1" size="4" maxlength="4" />
              -
              <input name="codpost2" value="'.$codpost2.'" type="text" id="codpost2" size="3" maxlength="3" /></td>
            <td align="left" class="left"><input name="telemovel" value="'.$telemovel.'" type="text" id="telemovel" size="25" maxlength="9" /></td>
            <td width="32" class="left">&nbsp;</td>
          </tr>
          <tr>
          ...
          <tr>
            <td height="20" align="left" valign="top" class="left"><input name="apelido" value="'.$apelido.'" type="text" id="apelido" size="35" /></td>
            <td height="20" align="left" valign="top" class="left"><input name="codpost3" value="'.$codpost3.'" type="text" id="codpost3" size="35" /></td>
            <td height="20" align="left" valign="bottom" class="left"><input type="checkbox" value="SIM" name="aceite">
              <span class="tahoma10white"  style= "color:#ffffff;font-size:10px;">Aceito as Condições de Registo deste Site.</span></td>
            <td width="32" height="20" valign="top"><input type="submit" name="button" id="button" value="OK" /></td>
      ...
      <tr>
        ...
        <td height="25" align class="tahoma10white" "left" style="color:#F00" ><br>
           '.$mensagemFinal.'&nbsp;</td>
        <td height="25">&nbsp;</td>
      </tr>
    </table></td>
