...
<tr> <td><strong>Nome da Empresa:</strong></td><td>
<tr> <td><input type="text" name="codpost1" value="'.$codpost1.'" size="25"> </tr>
...
<tr> <td>(+351)<input type="text" name="telemovel" value="'.$telemovel.'" size="25"> <strong>Receba informações sobre os nossos serviços no seu telemóvel por SMS.</strong></td></tr>




<tr> <td><br>Li e aceito os Termos e Condições de Utilização e Registo deste Site.  <input type="checkbox" value="SIM" name="aceite"><br /></tr> </td> <br/> 
