...
if($notificationemail == "1"){
		...
		$from = "acesso@impressoesesolucoes.com";
		$recipient = $email;
		$subject = "Registo no site da Impressões e Soluções, Lda";
		$body   = 'Obrigado '. $nome .
				'.<br>Agradecemos o seu registo no Site da Impressões e Soluções. <br /> Os dados da sua conta são:<br><hr> - utlizador: ' .
				$usn. '<br>- password: ' . $password .
				'<hr> Guarde este e-mail para futuros acessos à área de cliente do Site da Impressões e Soluções. <br> <br> Aceda ao site da Impressões e Soluções com a sua nova conta em:<br>www.impressoesesolucoes.com<br><br><br><br>A Equipa da Impressões e Soluções, Lda';
		//Send notification
...
- Utlizador: ' .
$usn. '<br>- Password: ' . $password .
'<br>Pode consultar estes dados através do e-mail que lhe enviámos. Guarde-os para futuros acessos ao nosso Site. <br><br><br><br>A equipa da Impressões e Soluções, Lda ';
}
...
<tr> <td>
 ...
 echo '</select>
    ...
    Insira a sua data de aniversário, para receber um presente.</tr></td>
