...
if (strlen($email) > 0 )
{ // se entra como parâmetro , é posto na sessão
...
if ( $tip_mov == "IN" || $tip_mov == "UPD" )  {
	...
	<tr><td>E-MAIL: </td><td> <input style="text-align:left" type="text" name="email" size="60" value="<?php echo $email;?>" class="sel2" onChange="checkEmail($email)">
	</td></tr>
	</table>	
	</p>
