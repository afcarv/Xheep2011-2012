 ...
 * @author jlnabais
 */
public class ResetRMIServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        //faz reset aos créditos do utilizador temp
        rmiServer.reset(temp);
        
        response.sendRedirect("/BetAndUin/LoginRMIServlet");
